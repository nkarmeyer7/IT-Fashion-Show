...
public class PlayerInteractions : MonoBehaviour
{
    ...
    {
        if (currentlyPickedUpObject.tag == "handleControl")
        {
            currentlyPickedUpObject.GetComponent<Handle_Controller>().Drop();
        }
    ...
    {
        physicsObject = lookObject.GetComponent<FPSGrab>();
        currentlyPickedUpObject = lookObject;
        pickupRB = currentlyPickedUpObject.GetComponent<Rigidbody>();
        pickupRB.constraints = RigidbodyConstraints.FreezeRotation;
        physicsObject.playerInteractions = this;
        StartCoroutine(physicsObject.PickUp());
        if (lookObject.tag == "handleControl")
        {
            lookObject.GetComponent<Handle_Controller>().PickUp();
        }
    }
}